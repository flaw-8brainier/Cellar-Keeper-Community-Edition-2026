...
# 🎮 Cellar Keeper — Community Edition

**Run your own cellar, from harvest to final pour.**
...
Cellar Keeper is a management simulation game in which players design, build, and operate their own underground cellar. Balance aging processes, climate control, storage logistics, and market sales while expanding the business year after year. This Community Edition is a standalone build distributed as a self-contained package. It runs offline and requires no storefront or additional software.

Intended for players who want a self-contained, offline copy of Cellar Keeper to install and run directly on their own PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4935510/f7fcd2e1551ed55158032e87c6977a959266a533/ss_f7fcd2e1551ed55158032e87c6977a959266a533.1920x1080.jpg?t=1788189419" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4935510/10ad21ab74096c0d52979e0578a4ecc998b84d12/ss_10ad21ab74096c0d52979e0578a4ecc998b84d12.1920x1080.jpg?t=1788189419" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4935510/29cecec548639e497b128f349f07ca0afca8973b/ss_29cecec548639e497b128f349f07ca0afca8973b.1920x1080.jpg?t=1788189419" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, German, French, Spanish, Polish, Russian, Simplified Chinese
- **Voiceover:** English
...
- 🍷 **Produce Aging** — Store barrels and bottles in real time as vintages mature and gain value.
- 🌡️ **Climate Control** — Adjust temperature and humidity per cellar section for optimal results.
- 🏗️ **Cellar Expansion** — Dig new rooms, install racks, and build tasting areas to grow the operation.
- 📈 **Market & Sales** — Track prices, negotiate with buyers, and release vintages at the right moment.
- 🧑‍🌾 **Staff Management** — Hire cellar masters and assign tasks across production and maintenance.
- 🍂 **Seasonal Cycle** — Plan around harvest seasons, festivals, and yearly demand shifts.
- 🎨 **Sandbox Mode** — Build freely with unlimited resources and no objectives.
- 📴 **Fully Offline** — Single-player gameplay that runs entirely offline after installation.
...
- Base game — includes all content
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti (2 GB) / AMD Radeon R7 360 | NVIDIA GeForce GTX 1050 Ti (4 GB) / AMD Radeon RX 570 |
| **Storage** | 4 GB available space | 4 GB available space (SSD) |
| **Additional** | DirectX 11 compatible system | DirectX 11 compatible system, keyboard and mouse |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\CellarKeeper\Saved`
